...
public class CommandBoxTest extends GuiUnitTest {
    ...
    private void assertBehaviorForFailedCommand() {
        ...
        assertFalse(((NewResultAvailableEvent) eventsCollectorRule.eventsCollector.getMostRecent()).isCorrectCommand);
    ...
    private void assertBehaviorForSuccessfulCommand() {
        ...
        assertTrue(((NewResultAvailableEvent) eventsCollectorRule.eventsCollector.getMostRecent()).isCorrectCommand);
        assertTrue(eventsCollectorRule.eventsCollector.getSize() == 1);
        eventsCollectorRule.eventsCollector.reset();
