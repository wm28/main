...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, INITAL_TOTAL_PERSONS);
     ...
     * sync status matches that of {@code expectedSyncStatus}, and the total persons matches that
