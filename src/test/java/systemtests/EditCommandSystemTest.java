...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        String command = " " + EditCommand.COMMAND_WORD + "  " + index.getOneBased() + "  " + NAME_DESC_BOB + "  "
                + PHONE_DESC_BOB + " " + EMAIL_DESC_BOB + "  " + PAYMENT_DESC_BOB + "  "
                + ATTENDANCE_DESC_BOB + " " + TAG_DESC_DIET_BOB + " ";
        Person editedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_DIET_BOB).build();
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + PAYMENT_DESC_BOB + ATTENDANCE_DESC_BOB + TAG_DESC_DIET_BOB;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + PAYMENT_DESC_AMY + ATTENDANCE_DESC_BOB + TAG_DESC_DIET_BOB;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + PAYMENT_DESC_BOB + ATTENDANCE_DESC_AMY + TAG_DESC_DIET_BOB;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_PERSON);
