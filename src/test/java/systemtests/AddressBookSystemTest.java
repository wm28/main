...
import guitests.guihandles.EventDetailsPanelHandle;
...
public abstract class AddressBookSystemTest {
    ...
    public EventDetailsPanelHandle getEventDetailsPanel() {
        return mainWindowHandle.getEventDetails();
    }
    ...
    /**
     * Calls {@code EventDetailsPanelHandle}, {@code PersonListPanelHandle} and {@code StatusBarFooterHandle} to remember
     * their current state.
     */
    ...
    protected void assertCommandBoxAndResultDisplayShowsDefaultStyle() {
        ...
        assertEquals(defaultStyleWhenCorrect, getResultDisplay().getStyleClass());
    }
     ...
     * {@code ClockRule#getInjectedClock()}, while the save location remains the same and
     * the total list remains the same.
     */
    protected void assertStatusBarUnchangedExceptSyncStatus() {
        ...
        assertFalse(handle.isSaveLocationChanged());
        assertTrue(handle.isTotalPersonsStatusChanged());
    }
