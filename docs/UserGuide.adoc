...
| image:ImportReportWindow.PNG[width="790"]
 +
  Figure 2 - ImportReportWindow: Shows the offending CSV guest entries with their associated error messages.
|====
****
...
You will mark the guests with unique ID of 00001, 708944, 928372, 00003 as present
...
Hakeem Salgado,80000957,\80000957@gmail.com,PAID,ABSENT,00004,gold,Veg,VIP +
Hibah Lees,80000882,\80000882@gmail.com,PAID,ABSENT,00005,gold,Veg,VIP +
Jayda Hill,80000251,\80000251@gmail.com,PAID,ABSENT,00006,gold,Veg,VIP +
****
