...
* `add_guest n/Bob Lee p/81720172 e/boblee@gmail.com a/Absent t/VIP t/Vegetarian t/Not Paid`
* `add_guest n/John Doe p/91028392 e/johndoe@gmail.com a/Present t/Groom t/Non-Vegetarian t/Paid`
...
Format: `edit_guest INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/PRESENT]
         [t/GUEST_TYPE] [t/DIET] [t/PAID]...`
...
// tag::start_marking[]
===  Start mass attendance marking : `start_marking` [To be implemented in future releases]
...
// tag::stop_marking[]
===  Stop mass attendance marking : `stop_marking` [To be implemented in future releases]
