...
With this command you can send an email to the guest at a specific Index +
Format: `email INDEX`
...
3. You will then need to fill in all the required fields. If you miss any of the fields and try to click the `Send` button, an error message will pop up like the one in *Figure 5*.
...
With this command you can an email to *all of the guests* in the current filtered list +
Format: `emailAll`
...
With this command you can send an email to all the guests with *at least one of the tags specified*+
