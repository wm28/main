...
Invités is developed as part of a team project for a software development module in National University of Singapore. I was tasked with the responsibility to implement a data sharing mechanism for the guest data within invites. Below is a breakdown of our various roles in the team, which consists of five members.
...
*** Reviewed pull requests (https://github.com/CS2113-AY1819S1-F09-3/main/pull/272[#272], https://github.com/CS2113-AY1819S1-F09-3/main/pull/232[#232])
