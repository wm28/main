...
* *Minor enhancement*: added a `addTag` and `removeTag` command that adds or removes a set of tags to all guests in the list
...
** Community
*** PRs reviewed for all milestones
** Tools
*** Integrated a third party library (JavaMail API)
