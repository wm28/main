...
This eliminates the need to key in the guest details manually and gives users an alternative if they decide to organise another event using the same guest list.
