...
=== *_Sections 3.7, 3.8, 3.16, 3.17, and 3.18 of the User Guide_*
include::../UserGuide.adoc[tag=addremovetag]

include::../UserGuide.adoc[tag=email]

=== *_Section 5 of the User Guide_*
...
=== *_Section 4.5 of the Developer Guide_*
include::../DeveloperGuide.adoc[tag=emailimplementation]

=== *_Appendix F.7 of the Developer Guide_*
