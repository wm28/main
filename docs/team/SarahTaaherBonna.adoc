...
* *Minor enhancement*: modified find command
** What it does: allows the user to find guests with the name(s), phone number(s) and/or email address(es),
depending on the prefix used.
