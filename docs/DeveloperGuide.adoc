...
image::EmailAllClassDiagram.png[width="800"]

As you can see above, *Figure 14* captures the main interactions between all classes when the user executes an `emailAll` command.
...
image::MailCommandActivityDiagram.png[width = "800"]

*Figure 15* represents an activity diagram when the _email_ command is executed. As you can see, the command involves *error checking*, followed by *creating an email object*, and finally *sending* this email to an individual guest.
