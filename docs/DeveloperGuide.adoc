...
. Send individual guests an email
...
.. *Test case:* `emailAll`
...   Expected: If current filtered list is empty, no email will be sent and an error message displayed.
...
. Send an email to a group of guests
