...
[discrete]
=== Use case: Import guest data and update payment details
...
=== Use case: Filter guest list based on status of payment and mass message those who have not payed
Actor: Application User - Event Planner
...
4. System shows an indexed list of these guests with their names, phone numbers, email address, attendance status and tags specified, if there are people in that category.
5. User enters a command to remind all in the currently displayed list.
...
4. System displays list of all such guests, displaying their name, phone number, email address, attendance status and tags, if there are people in that category.
5. User then enters command to list all guests.
6. System displays everyone on the guest list along with their name, phone number, email address, attendance status and tags.
...
1. User opens application and imports csv file/adds each guest in the application.
2. System will display the list of guests with details of each guest, such as name, phone number, email address and tags, such as, dietary requirements, VIP, paid or not paid, etc in a row for ease of access. System will display the general information of the event at the top of the list of guests, such as name, date, time and venue of event, dress code, number of people attending the event so far, etc. System asks user to enter a command.
