...
4. System shows an indexed list of these guests with their names, phone numbers, email address and tags specified, if there are people in that category.
5. User enters a command to remind all in the currently displayed list.
6. System sends all guests in the not paid list an email/text to remind them.
